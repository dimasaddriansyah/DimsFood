...
<body>
    <section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #F5F5F5">
        ...
        <div class="d-flex flex-column align-items-center h-100 flex-lg-row"
            style="font-family: 'Poppins', sans-serif;">
            <div class="position-relative d-none d-lg-block h-100 width-left-content-3-5">
                <img class="position-absolute img-fluid centered-content-3-5"
                    ...
                    <form style="margin-top: 1.5rem;" action="{{ route('loginPost') }}" method="post">
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <div class="d-flex w-100 div-input-content-3-5">
                                ...
                                <input class="input-field-content-3-5" type="password" name="password" id="password"
                        ...
                        <div class="text-end" style="margin-top: 0.75rem;">
                            <a href="#" class="forgot-password-content-3-5 font-italic">Forgot Password?</a>
                        </div>
                        <button class="btn btn-fill-content-3-5 d-block w-100">Login</button>
                        <a href="{{ route('user') }}" class="btn btn-fill-content-3-5 d-block">Back</a>
                    </form>
                    <p class="text-center bottom-caption-content-3-5">Already have an account yet?
                        <a href="{{ url('register') }}" class="green-bottom-caption-content-3-5">Register Here</a>
                    </p>
                </div>
            </div>
