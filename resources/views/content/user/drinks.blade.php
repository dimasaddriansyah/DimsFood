        ...
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-item active" style="background: url('assets_home/img/slide/slide-1.jpg');">
                ...
                <div class="carousel-content">
                    <h2 class="animate__animated animate__fadeInDown">List of <span>Drinks</span></h2>
                    <p class="animate__animated animate__fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
                    <div>
                    <a href="#why-us" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Drinks</a>
                    </div>
                </div>
                </div>
            </div>
    ...
    <section id="why-us" class="why-us mt-5">
        <div class="container mt-5">
            <div class="section-title">
                <h2>Drinks <span>Menu</span></h2>
                <p>Choise your drinks you want</p>
            </div>
            <div class="row">
