...
@section('content')
    ...
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <button class="btn btn-primary float-right px-4 mb-3" data-toggle="modal" data-target="#addDrinks" href=""><i class="fas fa-user-plus mr-2"></i> Add Drinks</button>
                    </div>
                </div>
    ...
    @section('modal')
    {{-- Add --}}
    <div class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" id="addDrinks">
...
<script>
    ...
    $('#addDrinks').on('shown.bs.modal', function() {
        $('#name').focus();
    })

    @if($errors->any())
        $('#addDrinks').modal('show')
    @endif
