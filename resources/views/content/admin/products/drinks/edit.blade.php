<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            <label for="name" class="form-label @error('name') text-danger @enderror">Drinks Name</label>
            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $drink->name }}"
                name="name" id="name">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('price') is-invalid @enderror "
                        value="{{ $drink->price }}" name="price" id="price"
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('stock') is-invalid @enderror"
                        value="{{ $drink->stock }}" name="stock" id="stock">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('description') is-invalid @enderror"
                value="{{ $drink->description }}" name="description" id="description">
