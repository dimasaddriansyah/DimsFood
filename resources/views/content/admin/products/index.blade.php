...
<div class="section-body">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <a href="{{ route('drinks.index') }}" class="btn btn-primary align-content-center float-left mb-3"><i class="fas fa-cube mr-2"></i>
                        Drinks
                    </a>
                    <a href="{{ route('foods.index') }}" class="btn btn-primary align-content-center float-left mb-3 ml-3"><i class="fas fa-cube mr-2"></i>
                        Foods
                    </a>
                </div>
                <div class="col-6">
                    @if (!empty($critical))
                            <a class="btn btn-warning text-white float-right ml-2" href="{{ route('products.critical') }}"><i class="fas fa-exclamation-triangle mr-2">
                                </i> Stock Critical <b>{{ $critical }}</b>
                            </a>
                        @endif
                        @if (!empty($sold))
                            <a class="btn btn-danger text-white float-right" href="{{ route('products.sold') }}"><i class="fas fa-ban mr-2">
...
@section('modal')
    ...
    {{-- @if($products->category = 'food')
        ...
        @endforeach
    @elseif($products->category = 'drink')
